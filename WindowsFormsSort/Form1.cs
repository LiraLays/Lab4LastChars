...
namespace WindowsFormsSort
{
    public partial class FormSort : Form
    {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            try
            {
                char[] massive = textBox2.Text.Trim().Split(',', ' ', ';').Select(char.Parse).ToArray();
                ...
                switch (comboBox2.SelectedItem.ToString())
                {
                    ...
                    case "Cортировка элементов 2 типов":
                        textBox3.Clear();
                        int cnt_uniq2 = new HashSet<char>(massive).Count;
                        if (cnt_uniq2 == 2)
                        {
                    ...
                    case "Cортировка элементов 3 типов":
                        textBox3.Clear();
                        int cnt_uniq3 = new HashSet<char>(massive).Count;                                              
                        if (cnt_uniq3 == 3)
                        {
                    ...
                    case "Cортировка элементов 4 типов":
                        textBox3.Clear();
                        int cnt_uniq4 = new HashSet<char>(massive).Count;
                        if (cnt_uniq4 == 4)
                        {
